...
FORMAT_SHORT_COLS="SERVICEID CPE_HOSTNAME|CPE_HOSTNAME_GUESS|HOSTNAME CPE_LOOPBACK|OBS_CE_MAN_LOOPBACK|MOBICUSTOMERLOOPBACK|MANAGEMENTIP|CPE_WAN_IP|LL_IPADDRESS VRF ACCOUNTID FULLNAME"
